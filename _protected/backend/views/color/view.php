...
<div class="color-view">
    ...
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Color').' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
                        
            <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model['idcolor']], ['class' => 'btn btn-primary']) ?>
            <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model['idcolor']], [
