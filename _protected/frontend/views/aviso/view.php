...
$this->title = Html::encode($model->marcaIdmarca->nombre." ".$model->modeloIdmodelo->nombre." ".$model->versionIdversion->nombre);
...
<div class="aviso-view">
    ...
    <h3><?= Html::encode($model->marcaIdmarca->nombre." ".$model->modeloIdmodelo->nombre." ".$model->versionIdversion->nombre) ?>
    ...
    if (isset($items)) {
        ...
        ?>
        <div id="sinFoto"><?= Icon::show('car', ['class'=>'fa-3x iconFontSize'], Icon::FA);?></div>
    <?php
    }
    ?>
        </div>
        <div class="col-md-6">
            ...
            echo DetailView::widget([
                ...
                'panel' => [
                    'heading' => Icon::show('car', ['class'=>'fa-1x'], Icon::FA).' Datos generales: '.strtoupper($this->title),
                ...
                'attributes' => [
                    ...
                    [
                        'attribute' =>  'puertas',
                        'value' => $model::getPuertaName($model->puertas),
                    ],
                    'kilometros',
                    [
                        'label' => 'Publicado',
        ...
        'attributes' => [
            [
                'columns' => [
                        ...
                        [
                            'attribute' => 'aperturabaul',
                            'value' => ($modelConfort->aperturabaul == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                            'format' => 'html',
                        ],
                        [
            ...
            [
                'columns' => [
                    [
                        'attribute' => 'atraserorebatible',
                        'value' => ($modelConfort->atraserorebatible == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                    [
            ...
            [
                'columns' => [
                    [
                        'attribute' => 'acuero',
                        'value' => ($modelConfort->acuero == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                    [
            ...
            [
                'columns' => [
                    [
                        'attribute' => 'tsolar',
                        'value' => ($modelConfort->tsolar == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                    [
                    ...
                    [
                        'attribute' => 'velectricotra',
                        'value' => ($modelConfort->velectricotra == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                ],
            ],
        ...
        'attributes' => [
            ...
            [
                'columns' => [
                    [
                        'attribute' => 'atrasero',
                        'value' => ($modelSeguridad->atrasero == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                    [
                        'attribute' => 'acortina',
                        'value' => ($modelSeguridad->acortina == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                    [
                        'attribute' => 'alarma',
            ...
            [
                'columns' => [
                    ...
                    [
                        'attribute' => 'apoyacabeza',
                        'value' => ($modelSeguridad->apoyacabeza == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                    [
                        'attribute' => 'cierremov',
            ...
            [
                'columns' => [
                    ...
                    [
                        'attribute' => 'fdiscot',
                        'value' => ($modelSeguridad->fdiscot == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                    [
                        'attribute' => 'imotor',
            ...
            [
                'columns' => [
                    ...
                    [
                        'attribute' => 'tluzstop',
                        'value' => ($modelSeguridad->tluzstop == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                ],
            ],
            [
                'columns' => [
                    ...
                    [
                        'attribute' => 'isofix',
                        'value' => ($modelSeguridad->isofix == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                ],
            ],
        ...
        'attributes' => [
            [
                'columns' => [
                    [
                        'attribute' => 'pequipaje',
                        'value' => ($modelExterior->pequipaje == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                    [
                        'attribute' => 'fxenon',
            ...
            [
                'columns' => [
                    ...
                    [
                        'attribute' => 'aleacion',
                        'value' => ($modelExterior->aleacion == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                    [
                        'attribute' => 'tdescapota',
                        'value' => ($modelExterior->tdescapota == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                ],
            ],
            [
                'columns' => [
                    ...
                    [
                        'attribute' => 'pcarter',
                        'value' => ($modelExterior->pcarter == 0) ? '<span class="glyphicon glyphicon-remove"></span>':'<span class="glyphicon glyphicon-ok"></span>',
                        'format' => 'html',
                    ],
                ],
            ],
