...
<div class="aviso-form">
    ...
    <div class="container-fluid">
        ...
        <div class="form-group-sm col-xs-12 col-md-6">
            ...
            <?= $form->field($model, 'marca_idmarca')->widget(\kartik\widgets\Select2::classname(), [
                'data' => \yii\helpers\ArrayHelper::map(\common\models\Marca::find()->where(['tipovehiculo'=>Marca::CASARODANTE])->orderBy('nombre')->asArray()->all(), 'idmarca', 'nombre'),
            ...
            <?= $form->field($model, 'marchas')->textInput(['maxlength' => 255]) ?>

            <?= $form->field($model, 'motor')->textInput(['maxlength' => 255]) ?>
            ...
            <?= $form->field($model, 'capacidadtanque')->widget(\yii\widgets\MaskedInput::className(), [
                'mask' => '9',
                'clientOptions' => ['repeat' => 7, 'greedy' => false]
            ]) ?>

            <?= $form->field($model, 'largototal')->textInput(['maxlength' => 5,'placeholder' => Yii::t('app', 'Ej.: 12.5')]) ?>

            <?= $form->field($model, 'cpersonas')->widget(\yii\widgets\MaskedInput::className(), [
                'mask' => '9',
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <?=
            $form->field($modelExterior, 'etecho', [
                'template' => '{input}{label}{error}',
                'labelOptions' => ['class' => 'cbx-label'],
            ])->widget(CheckboxX::classname(), [
                'autoLabel' => true,
