...
<div class="aviso-form">
    ...
    <div class="container-fluid">
        ...
        <div class="form-group-sm col-xs-12 col-md-6">
            ...
            <?= $form->field($model, 'marca_idmarca')->widget(\kartik\widgets\Select2::classname(), [
                'data' => \yii\helpers\ArrayHelper::map(\common\models\Marca::find()->where(['tipovehiculo'=>Marca::CAMION])->orderBy('nombre')->asArray()->all(), 'idmarca', 'nombre'),
            ...
            <?= $form->field($model, 'potmaxima')->textInput(['maxlength' => 255]) ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <?=
            $form->field($modelConfort, 'scabina', [
                'template' => '{input}{label}{error}',
                'labelOptions' => ['class' => 'cbx-label'],
            ])->widget(CheckboxX::classname(), [
                'autoLabel' => true,
